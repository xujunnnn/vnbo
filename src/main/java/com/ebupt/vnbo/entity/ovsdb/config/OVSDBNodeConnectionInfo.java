...
public class OVSDBNodeConnectionInfo {
	@JSONField(name="remote-ip")
	private String remote_ip;
	@JSONField(name="remote-port")
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		OVSDBNodeConnectionInfo other = (OVSDBNodeConnectionInfo) obj;
		if (remote_ip == null) {
	...
	public String toString() {
		return "OVSDBNodeConnectionInfo [remote_ip=" + remote_ip + ", remote_port=" + remote_port + "]";
	}
