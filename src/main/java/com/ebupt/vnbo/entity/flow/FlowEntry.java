package com.ebupt.vnbo.entity.flow;
...
import com.ebupt.vnbo.entity.flow.flow_static.Flow_Statistic;
 ...
 * 
* ����: FlowEntry.java <br/>
* ���� : com.ebupt.vnbo.classes.flow <br/>
* ��ϸ����: TODO(FlowEntry�������ʵ����) <br/>
* ������Ա�� xujun   <br/>
* �������ڣ�2017��6��16�� <br/>
* �����汾�� V1.0  <br/>
 */
public class FlowEntry implements Config,Operational {
	...
	public void send(String node) throws ODL_IO_Exception {
		...
		if(!"200".equals(responsecode) && ! "201".equals(responsecode)){
			...
			throw new ODL_IO_Exception("flow"+this.getId()+"sended to"+node+"failed");	
		}
	...
	public FlowEntry read(String node) throws ODL_IO_Exception{
		// TODO Auto-generated method stub
