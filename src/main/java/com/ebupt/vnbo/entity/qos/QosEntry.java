...
import com.ebupt.vnbo.entity.meter.MeterEntry;
...
public class QosEntry implements Config,Operational {
	...
	* @throws
	...
	private HashSet<String> getNodes() throws ODL_IO_Exception {
		HashSet<String> nodes=new HashSet<String>();
		if(this.Srchost!=null && this.Desthost!=null){
			Host Srchost=topologyService.get_host_from_ip(this.Srchost.split("/")[0]);
			Host Desthost=topologyService.get_host_from_ip(this.Desthost.split("/")[0]);
			...
			for(Node n:topologyService.get_access_node()){
